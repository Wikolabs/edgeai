...
export const metadata: Metadata = { title:"EdgeAI — Inference IA embarquee sans cloud", description:"Deploiement de modeles IA sur hardware edge : Raspberry Pi, Jetson, STM32. Latence inferieure a 10ms. Zero dependance cloud." };

...
const P = {
  ...
  taglineAccentIdx: 1,
  desc: "EdgeAI deploie vos modeles de machine learning directement sur Raspberry Pi, NVIDIA Jetson et microcontroleurs. Inference locale, souverainte totale, disponibilite hors reseau.",
  accent: "#F59E0B",
  ...
  testimonials: [
    { quote: "On avait besoin d'inference temps reel sur nos cameras de chaine de production sans exposer nos donnees. EdgeAI a livre un POC fonctionnel en 48h. Latence de 8ms, zero cloud.", author: "Jean-Luc P.", role: "Responsable Industrie 4.0, Groupe Industriel" },
    { quote: "Nos capteurs IoT dans des zones sans reseau pouvaient enfin executer des modeles de detection d'anomalie. EdgeAI a transforme notre approche maintenance predictive.", author: "Nathalie B.", role: "CTO, Scale-up DeepTech" },
  ],
      ...
      <section id="features" style={{ padding:"80px 40px", maxWidth:1100, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:52 }}>
          ...
          <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif", lineHeight:1.15 }}>
            Intelligence locale, <em style={{ fontStyle:"italic", color:gold }}>performance maximale</em>
          </h2>
        </div>
        ...
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:48 }}>
            ...
            <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif" }}>
              POC livre en <em style={{ fontStyle:"italic", color:accent }}>48 heures</em>
            </h2>
          </div>
